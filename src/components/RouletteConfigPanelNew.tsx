              ...
              <textarea
                ...
                onChange={(e) => {
                  ...
                  updateSector(selectedSector.id, { 
                    displayName: text,
                    textLines: textLines.length > 0 ? textLines : [text]
                  });
                }}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Texto del sector (usa Enter para múltiples líneas)"
                rows={3}
              />
              <div className="text-xs text-gray-500 mt-1">
                💡 Usa Enter para crear múltiples líneas de texto
              </div>
            </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (onVisualConfigChange) {
                        onVisualConfigChange(ROULETTE_PRESETS[preset.id as RoulettePresetName]);
                      }
                    }}
            ...
            <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center">
                  <input 
                    type="checkbox" 
                    checked={visualConfig.shadowEnabled || false}
                    onChange={(e) => {
                      if (onVisualConfigChange) {
                        onVisualConfigChange({
                          ...visualConfig,
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      min="0"
                      max="50"
                      value={visualConfig.shadowBlur || 20}
                      onChange={(e) => {
                        if (onVisualConfigChange) {
                          onVisualConfigChange({
                            ...visualConfig,
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="0"
                      max="20"
                      value={visualConfig.shadowOffsetY || 10}
                      onChange={(e) => {
                        if (onVisualConfigChange) {
                          onVisualConfigChange({
                            ...visualConfig,
            ...
            <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center">
                  <input 
                    type="checkbox" 
                    checked={visualConfig.centerCircle?.enabled || true}
                    onChange={(e) => {
                      if (onVisualConfigChange) {
                        onVisualConfigChange({
                          ...visualConfig,
                          centerCircle: {
                            ...visualConfig.centerCircle,
                            enabled: e.target.checked,
                            color: visualConfig.centerCircle?.color || '#FFFFFF',
                            radius: visualConfig.centerCircle?.radius || 30
                          }
                        });
                      }
                    }}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      type="color"
                      value={visualConfig.centerCircle?.color || '#FFFFFF'}
                      onChange={(e) => {
                        if (onVisualConfigChange) {
                          onVisualConfigChange({
                            ...visualConfig,
                            centerCircle: {
                              ...visualConfig.centerCircle,
                              enabled: visualConfig.centerCircle?.enabled || true,
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="10"
                      max="60"
                      value={visualConfig.centerCircle?.radius || 30}
                      onChange={(e) => {
                        if (onVisualConfigChange) {
                          onVisualConfigChange({
                            ...visualConfig,
