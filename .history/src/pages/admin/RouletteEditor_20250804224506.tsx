                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <input
                      type="file"
                      accept="image/*"
                      onChange={(e) => setConfig(prev => ({ ...prev, backgroundImage: e.target.files?.[0] }))}
                    ...
                    <input
                      type="file"
                      accept="image/png"
                      onChange={(e) => setConfig(prev => ({ ...prev, borderImage: e.target.files?.[0] }))}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:border-purple-500 focus:outline-none"
                    />
                    ...
                    <input
                      type="file"
                      accept="image/png"
                      onChange={(e) => setConfig(prev => ({ ...prev, centerMarkerImage: e.target.files?.[0] }))}
                      className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:border-purple-500 focus:outline-none"
                    />
                  ...
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                    <div className="aspect-w-9 aspect-h-16 bg-black relative">
                      {config.backgroundImage && (
                        <img
                          src={URL.createObjectURL(config.backgroundImage)}
                          alt="Fondo"
                      ...
                      <RouletteWheel
                        ...
                        borderImage={config.borderImage ? URL.createObjectURL(config.borderImage) : undefined}
                        borderSize={config.borderSize}
                        centerMarkerImage={config.centerMarkerImage ? URL.createObjectURL(config.centerMarkerImage) : undefined}
