                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2">
                                  ...
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={e => updateSector(sector.id, { fontSize: parseInt(e.target.value) || 16 })}
                                      className="w-full"
                                    />
                                  </div>
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={e => updateSector(sector.id, { lineHeight: parseFloat(e.target.value) || 1.2 })}
                                      className="w-full"
                                    />
                                  </div>
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={e => updateSector(sector.id, { letterSpacing: parseFloat(e.target.value) || 0 })}
                                      className="w-full"
                                    />
                                  </div>
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={e => updateSector(sector.id, { interlineSpacing: parseFloat(e.target.value) || 0 })}
                                      className="w-full"
                                    />
                                  </div>
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={e => updateSector(sector.id, { interletterSpacingLine2: parseFloat(e.target.value) || 0 })}
                                      className="w-full"
                                    />
                                  </div>
                                  ...
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={e => updateSector(sector.id, { distanceFromCenter: parseInt(e.target.value) || 70 })}
                                      className="w-full"
                                    />
                                  </div>
                                </div>
