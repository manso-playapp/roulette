                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button
                        onClick={processAllCommas}
                        className="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 
                                 transition-colors flex items-center space-x-2 text-sm"
                        title="Convierte automáticamente las comas en saltos de línea en todos los sectores"
                      >
                        <span>📝</span>
                        <span>Procesar Comas</span>
                      </button>
                      <button
                        onClick={centerAllTexts}
                        className="px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 
                                 transition-colors flex items-center space-x-2 text-sm"
                        title="Centra perfectamente todos los textos (resetea el interletrado)"
                      >
                        <span>🎯</span>
                        <span>Centrar Textos</span>
                      </button>
                    </div>
