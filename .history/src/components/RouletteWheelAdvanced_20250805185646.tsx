...
export const RouletteWheelAdvanced: React.FC<RouletteWheelAdvancedProps> = ({
  ...
  useEffect(() => {
    ...
    sectors.forEach((sector, index) => {
      ...
      const textLines = (sector as RouletteSectorMultiLine).textLines || [sector.displayName];
      const lineSpacing = (sector as RouletteSectorMultiLine).lineSpacing || fontSize * 0.2;
      const maxLines = Math.min(textLines.length, (sector as RouletteSectorMultiLine).maxLines || 3);
