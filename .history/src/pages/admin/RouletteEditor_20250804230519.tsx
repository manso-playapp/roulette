        ...
        {activeTab === 'personalization' && (
          <div className="space-y-6">
            ...
            {config.sectors.length === 0 ? (
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 h-[calc(100vh-20rem)] overflow-hidden">
                {/* Columna izquierda: Configuración y personalización (sin scroll) */}
                <div className="space-y-6 overflow-y-auto pr-2">
                  ...
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                    ...
                    <div className="space-y-4">
                      {/* Imagen de Fondo */}
                      <div>
                        <label className="block text-xs font-medium text-gray-300 mb-2">Imagen de Fondo</label>
                        <input
                          type="file"
                          accept="image/*"
                          onChange={(e) => {
                        ...
                        {backgroundImage && (
                          <div className="mt-2">
                            <img src={backgroundImage} alt="Fondo" className="w-full h-20 object-cover rounded" />
                          </div>
                        )}
                      </div>
                      ...
                      {/* Borde de la Ruleta */}
                      <div>
                        <label className="block text-xs font-medium text-gray-300 mb-2">Borde de la Ruleta (PNG)</label>
                        <input
                          type="file"
                          accept="image/png"
                          onChange={(e) => {
                        ...
                        {borderImage && (
                          <div className="mt-2">
                            <img src={borderImage} alt="Borde" className="w-16 h-16 object-cover rounded" />
                          </div>
                        )}
                        <div className="mt-2">
                          <label className="block text-xs text-gray-300 mb-1">Tamaño del Borde: {borderSize.toFixed(1)}</label>
                          <input
                            type="range"
                            min="0"
                            max="4"
                      ...
                      {/* Marcador Central */}
                      <div>
                        <label className="block text-xs font-medium text-gray-300 mb-2">Marcador Central (PNG)</label>
                        <input
                          type="file"
                          accept="image/png"
                          onChange={(e) => {
                        ...
                        {centerMarkerImage && (
                          <div className="mt-2">
                            <img src={centerMarkerImage} alt="Marcador" className="w-16 h-16 object-cover rounded" />
                          </div>
                        )}
                        <div className="mt-2">
                          <label className="block text-xs text-gray-300 mb-1">Tamaño del Marcador: {centerMarkerSize.toFixed(1)}</label>
                          <input
                            type="range"
                            min="0"
                            max="8"
                ...
                {/* Columna derecha: Vista previa con proporción 9:16 */}
                <div className="space-y-4 flex flex-col h-full">
                  <h3 className="text-xl font-semibold text-white font-display">Vista Previa</h3>
                  
                  {/* Vista previa con proporción 9:16 */}
                  <div className="bg-black rounded-lg overflow-hidden flex-1" style={{ aspectRatio: '9/16' }}>
