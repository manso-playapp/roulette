...
export const RouletteWheel: React.FC<RouletteWheelProps> = ({
  ...
  // Tamaño visual del canvas en píxeles CSS
  const visualWidth = typeof window !== 'undefined' ? Math.round(window.innerWidth * 0.8) : width;
  ...
  return (
    <div className={`relative ${className}`}>
      <canvas
        ...
        style={{ width: '80vw', height: '80vw', maxWidth: '80vw', maxHeight: '80vw', display: 'block' }}
        width={visualWidth * (window.devicePixelRatio || 1)}
        height={visualHeight * (window.devicePixelRatio || 1)}
      />
