        ...
        <div className="flex space-x-4">
          <button
            ...
            className={`
              ...
              ${animation.isSpinning || activeSectorsCount === 0
                ...
                : 'bg-gradient-to-r from-purple-600 to-blue-500 text-white hover:from-purple-700 hover:to-blue-600 transform hover:scale-105 shadow-lg'
              }
            `}
          >
          ...
          {(lastResult || animation.currentAngle > 0) && (
            <button
              ...
              className="px-6 py-3 rounded-lg font-medium text-gray-700 bg-gray-200 hover:bg-gray-300 transition-colors duration-200"
            >
              🔄 Resetear
            </button>
          )}
