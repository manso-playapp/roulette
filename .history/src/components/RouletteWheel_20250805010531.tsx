  ...
  useEffect(() => {
    ...
    activeSectors.forEach((sector, index) => {
      ...
      textLines.forEach((line, lineIndex) => {
        ...
        // MÉTODO SIMPLE: Solo aplicar espaciado si es realmente necesario
        const letterSpacing = sector.letterSpacing ?? 0;
        
        if (Math.abs(letterSpacing) > 0.5) {
          // Solo para espaciados significativos (> 0.5px)
          ...
          // Empezar desde posición centrada
          let x = -totalWidth / 2;
          ...
          // SIEMPRE usar centrado automático para casos normales
          // Esto garantiza centrado perfecto
