...
const RouletteEditor: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'texto' | 'diseno' | 'icono'>('texto');
  const [activeMainTab, setActiveMainTab] = useState<'sectors' | 'config'>('sectors');
  const [borderImageDecorative, setBorderImageDecorative] = useState<string>('');
  const [centerImageDecorative, setCenterImageDecorative] = useState<string>('');
  const [borderScale, setBorderScale] = useState<number>(1.0);
  const [centerScale, setCenterScale] = useState<number>(1.0);
          ...
          <div className="space-y-6">
            ...
            {config.sectors.length === 0 ? (
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                {/* Columna izquierda: Configuración (1/3) */}
                <div className="xl:col-span-2 space-y-6">
                  {/* Pestañas principales */}
                  <div className="bg-white/5 rounded-lg border border-white/10">
                    <div className="flex border-b border-white/10">
                      <button
                        onClick={() => setActiveMainTab('sectors')}
                        ...
                        <div className="space-y-4">
                          <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-3">
                              <h4 className="text-lg font-medium text-white">Sectores</h4>
                              {copiedStyle && (
                    ...
                    {config.sectors.length > 0 && (
                      <div className="mt-4 p-3 bg-white/5 rounded-lg border border-white/10">
                        ...
                        <div className="text-xs text-gray-400 space-y-1">
                          ...
                          <div className="space-y-6">
                            <h4 className="text-lg font-medium text-white">Configuración General</h4>
                            ...
                            <div className="space-y-4">
                              <h5 className="text-md font-medium text-purple-300">Imágenes Decorativas</h5>
                              ...
                              <div className="space-y-3">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      if (file) {
                                        ...
                                        reader.onload = () => setBorderImageDecorative(reader.result as string);
                                        reader.readAsDataURL(file);
                                      }
                                    }}
                                    className="flex-1 text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 
                                             file:rounded-lg file:border-0 file:text-sm file:font-medium 
                                             file:bg-purple-600 file:text-white hover:file:bg-purple-700"
                                  />
                                  {borderImageDecorative && (
                                    <button
                                      onClick={() => setBorderImageDecorative('')}
                                ...
                                {borderImageDecorative && (
                                  <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                      <span className="text-xs text-gray-300">Escala del Borde</span>
                                      <span className="text-xs text-purple-300">{borderScale.toFixed(1)}px</span>
                                    </div>
                                    <input
                                      type="range"
                                      min="0.1"
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="flex items-center space-x-4">
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      if (file) {
                                        const reader = new FileReader();
                                        reader.onload = () => setCenterImageDecorative(reader.result as string);
                                        reader.readAsDataURL(file);
                                      }
                                    }}
                                    className="flex-1 text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 
                                             ...
                                             file:bg-purple-600 file:text-white hover:file:bg-purple-700"
                                  />
                                  {centerImageDecorative && (
                                    <button
                                      onClick={() => setCenterImageDecorative('')}
                                      className="px-3 py-2 text-red-400 hover:text-red-300 text-sm"
                                    >
                                      ✕
                                    </button>
                                ...
                                {centerImageDecorative && (
                                  <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                      <span className="text-xs text-gray-300">Escala del Centro</span>
                                      <span className="text-xs text-purple-300">{centerScale.toFixed(1)}px</span>
                                    </div>
                                    <input
                                      type="range"
                                      min="0.1"
                                      ...
                                      step="0.1"
                                      value={centerScale}
                                      onChange={(e) => setCenterScale(parseFloat(e.target.value))}
                                      className="w-full slider-enhanced"
                                    />
                                  </div>
                                )}
                            ...
                            <div className="space-y-4">
                              <h5 className="text-md font-medium text-purple-300">Comportamiento</h5>
