                            ...
                            <div className="p-3 bg-white/5 border-t border-white/10">
                              <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2">
                                  ...
                                  <div>
                                    <label className="block text-xs font-medium text-gray-300 mb-1">Tamaño</label>
                                    <input
                                      type="number"
                                      min={10}
                                      max={64}
                                  ...
                                  <div>
                                    <label className="block text-xs font-medium text-gray-300 mb-1">Interlineado</label>
                                    <input
                                      type="number"
                                      min={0.8}
                                      max={2.5}
                                  ...
                                  <div>
                                    <label className="block text-xs font-medium text-gray-300 mb-1">Interletrado</label>
                                    <input
                                      type="number"
                                      min={-2}
                                      max={10}
                                  ...
                                  <div>
                                    <label className="block text-xs font-medium text-gray-300 mb-1">Espaciado entre líneas</label>
                                    <input
                                      type="number"
                                      min={0}
                                      max={10}
                                  ...
                                  <div>
                                    <label className="block text-xs font-medium text-gray-300 mb-1">Interletrado línea 2</label>
                                    <input
                                      type="number"
                                      min={-2}
                                      max={10}
                                  ...
                                  <div>
                                    <label className="block text-xs font-medium text-gray-300 mb-1">Distancia desde el centro</label>
                                    <input
                                      type="number"
                                      min={30}
                                      max={100}
